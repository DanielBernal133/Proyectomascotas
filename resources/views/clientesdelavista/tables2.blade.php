                                        ...
                                        <div class="myaccount-content">
                                            ...
                                            <div class="myaccount-table table-responsive text-center">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                    <?php $consultas =DB::table('pedido')
                                                                    ->join('cliente', 'pedido.idClienteFK' , '=', 'cliente.idCliente')
                                                                    ->where('idUsuarioFK', Auth::user()->idUsuario)
                                                                    ->doesntExist()?>
                                                    @if ($consultas)
                                        ...
                                        <div class="myaccount-content">
                                            ...
                                            <div class="myaccount-table table-responsive text-center">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>Gimnasio para gatos</td>
                                                            <td>14/09/2021</td>
                                                            <td>Si</td>
                                                            <td><a href="#" class="btn flosun-button secondary-btn theme-color  rounded-0"><i class="fa fa-cloud-download mr-2"></i>Descargar</a></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Snake perro</td>
                                                            <td>15/05/2021</td>
                                        ...
                                        <center><legend>Actulizar Usuario {{ $cliente->nombre }} {{ $cliente->apellido}}</legend></center>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-custom">
                                                    <div class="single-input-item mb-3">
                                                        ...
                                                        <input value="{{$cliente->name}}" name="name" type="text" placeholder="" class="form-control input-md">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-custom">
                                                    <div class="single-input-item mb-3">
                                                        <label for="last-name" class="required mb-1">Apellido</label>
                                                        <input value="{{$cliente->apellido}}" name="apellido" type="text" placeholder="" class="form-control input-md">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-custom">
                                                    ...
                                                    <input value="{{$cliente->email}}" name="email" type="email" placeholder="" class="form-control input-md">
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                                    <div class="col-lg-6 col-custom">
                                                            <div class="single-input-item mb-3">
                                                                ...
                                                                <input type="password" id="new-pwd" placeholder=""name="password" />
                                                    ...
                                                    <div class="col-lg-6 col-custom">
                                                            <div class="single-input-item mb-3">
                                                                ...
                                                                <input type="password" id="confirm-pwd" placeholder=""name="password_confirmation" />
